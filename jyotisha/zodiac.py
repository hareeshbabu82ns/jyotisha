...
class NakshatraDivision(object):
    ...
    def set_time(self, julday):
        ...
        self.right_boundaries = (
            (numpy.arange(27) + 1) * (360.0 / 27.0) + swe.get_ayanamsa(julday)) % 360
    ...
    def get_stellarium_nakshatra_boundaries(self):
        ...
        ecliptic_north_pole = swe.cotrans(
            lon=20, lat=90, dist=9999999, obliquity=23.437404)
        ...
        ecliptic_south_pole = swe.cotrans(
            lon=20, lat=-90, dist=9999999, obliquity=23.437404)
...
def get_planet_lon(jd, planet, offset=0, ayanamsha_id=swe.SIDM_LAHIRI):
    ...
    """
    swe.set_sid_mode(ayanamsha_id)
    lon = (swe.calc_ut(jd, planet)[0][0] - swe.get_ayanamsa(jd)) % 360
    return lon + offset
